...
Themes.List = {
	Dark = {
		Window        = Color3.fromRGB(28, 28, 31),
		Sidebar       = Color3.fromRGB(36, 36, 40),
		SidebarHover  = Color3.fromRGB(255, 255, 255),
		Selection     = Color3.fromRGB(62, 62, 68),
		Group         = Color3.fromRGB(45, 45, 51),
		...
		SubText       = Color3.fromRGB(168, 168, 176),
